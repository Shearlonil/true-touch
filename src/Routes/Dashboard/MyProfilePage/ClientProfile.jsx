...
const ClientProfilePage = () => {
    ...
    const { updatePersonalInfo, logoutAll } = useAuth();
    const { updatePassword, markEmailForUpdate } = useUserController();
        ...
        <section className='container' style={{minHeight: '60vh'}}>
            ...
            <Row className='mt-4'>
                <div className="d-flex flex-wrap gap-4 align-items-center justify-content-center col-md-6 col-sm-12" >
                    <img src={IMAGES.member_icon} alt ="Avatar" className="rounded-circle" width={200} height={200} />
                </div>
            </Row>
